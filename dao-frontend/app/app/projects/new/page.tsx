...
export default function NewProject(){
 ...
 async function submit(e:FormEvent){e.preventDefault();setError('');
  ...
  if(form.date && form.endDate && form.endDate < form.date){setError('La date de fin doit être postérieure ou égale à la date de début.');return;}
